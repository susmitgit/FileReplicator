...
/**
* A sequence of FileDescription instances.
*/
public final class FileDescriptionSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public FileDescriptionSeq() {
        super(FileDescription.class);
    }

    public FileDescriptionSeq (int initialMaximum) {
        super(FileDescription.class, initialMaximum);
    }

    public FileDescriptionSeq (Collection elements) {
        super(FileDescription.class, elements);
    }
