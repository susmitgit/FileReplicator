...
public class FileSegmentTypeSupport extends TypeSupportImpl {
    ...
    private static final String TYPE_NAME = "com::rti::dds::example::file::messages::FileSegment";
    ...
    */
    ...
    public static TypeCode getTypeCode(){
        return FileSegmentTypeCode.VALUE;
    }

    public Object create_data() {
        return FileFragment.create();
    }
    ...
    */
    public Object copy_data(Object destination, Object source) {
        ...
        FileFragment typedDst = (FileFragment) destination;
        FileFragment typedSrc = (FileFragment) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += com.rti.dds.example.file.messages.FileDescriptionTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.BYTE.getSequenceMaxSizeSerialized(currentAlignment, ((com.rti.dds.example.file.messages.MAX_FILE_SEGMENT_SIZE.VALUE)));
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += com.rti.dds.example.file.messages.FileDescriptionTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        FileFragment typedSrc = (FileFragment) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += com.rti.dds.example.file.messages.FileDescriptionTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.fileDescription);
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=   CdrPrimitiveType.BYTE.getSequenceSerializedSize(
            currentAlignment , typedSrc.contents );      
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            com.rti.dds.example.file.messages.FileDescriptionTypeSupport.get_instance().serialize(endpoint_data, typedSrc.fileDescription, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            dst.writeInt(typedSrc.segmentNumber);

            dst.writeInt(typedSrc.totalSegmentCount);

            dst.writeByteSeq(typedSrc.contents,((com.rti.dds.example.file.messages.MAX_FILE_SEGMENT_SIZE.VALUE)));
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            FileFragment typedDst = (FileFragment) dst;
            typedDst.clear();      
            try{
                typedDst.fileDescription = (com.rti.dds.example.file.messages.FileDescription)com.rti.dds.example.file.messages.FileDescriptionTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.fileDescription, src, false, true, endpoint_plugin_qos);     
                typedDst.segmentNumber = src.readInt();
                typedDst.totalSegmentCount = src.readInt();
                src.readByteSequence(typedDst.contents, ((com.rti.dds.example.file.messages.MAX_FILE_SEGMENT_SIZE.VALUE)));
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            com.rti.dds.example.file.messages.FileDescriptionTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            FileFragment typedDst = (FileFragment) sample;
    ...
    protected FileSegmentTypeSupport() {
        ...
        super(TYPE_NAME, false,FileSegmentTypeCode.VALUE,FileFragment.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected FileSegmentTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,FileSegmentTypeCode.VALUE,FileFragment.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
