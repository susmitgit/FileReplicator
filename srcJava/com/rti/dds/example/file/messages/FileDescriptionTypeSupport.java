...
public class FileDescriptionTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "com::rti::dds::example::file::messages::FileDescription";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final FileDescriptionTypeSupport _singleton
    = new FileDescriptionTypeSupport();
    ...
    */
    public static FileDescriptionTypeSupport get_instance() {
        return _singleton;
    }

    public static FileDescriptionTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return FileDescriptionTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>FileDescription</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        FileDescription typedDst = (FileDescription) destination;
        FileDescription typedSrc = (FileDescription) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, (((com.rti.dds.example.file.messages.MAX_PATH_COMPONENT_SIZE.VALUE)))+1);
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, (((com.rti.dds.example.file.messages.MAX_PATH_COMPONENT_SIZE.VALUE)))+1);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        FileDescription typedSrc = (FileDescription) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.path );
        currentAlignment  +=  CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.name,((com.rti.dds.example.file.messages.MAX_PATH_COMPONENT_SIZE.VALUE)));

            dst.writeString(typedSrc.path,((com.rti.dds.example.file.messages.MAX_PATH_COMPONENT_SIZE.VALUE)));

            dst.writeLong(typedSrc.size);

            dst.writeLong(typedSrc.lastModifiedDate);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            FileDescription typedDst = (FileDescription) dst;
            typedDst.clear();      
            try{
                typedDst.name = src.readString(((com.rti.dds.example.file.messages.MAX_PATH_COMPONENT_SIZE.VALUE)));
                typedDst.path = src.readString(((com.rti.dds.example.file.messages.MAX_PATH_COMPONENT_SIZE.VALUE)));
                typedDst.size = src.readLong();
                typedDst.lastModifiedDate = src.readLong();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            FileDescription typedDst = (FileDescription) sample;
    ...
    protected FileDescriptionTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,FileDescriptionTypeCode.VALUE,FileDescription.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected FileDescriptionTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,FileDescriptionTypeCode.VALUE,FileDescription.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
